...
def process_mini_batch_data(rna_path, atac_path, device,
                            ...
                            emb_size, use_highly_variable, cor):
    ...
    scRNA_adata_test = scRNA_adata[:num_of_cell, :num_of_gene]

    X_rna_test = scRNA_adata.X.toarray()[:num_of_cell, :num_of_gene]
    ...
    scRNA_test_anndata = anndata.AnnData(
        X=scRNA_adata.X[:num_of_cell, :num_of_gene].toarray())
    ...
    =====================================================================================
    """
    scATAC_adata_test = scATAC_adata[:num_of_cell, :num_of_peak]

    X_atac_test = scATAC_adata.X.toarray()[:num_of_cell, :num_of_peak]
    ...
    scATAC_test_anndata = anndata.AnnData(
        X=scATAC_adata.X[:num_of_cell, :num_of_peak].toarray())
    ...
    for i in range(batch_num):
        ...
        scRNA_adata_mini_batch = scRNA_adata[selected_cells, :]
        ...
        scATAC_adata_mini_batch = scATAC_adata[selected_cells, :]
