...
def train(model_tuple, optimizer,
    ...
    for i in range(niter):
        ...
        if (i+1) % ari_freq == 0:
            ...
            correlation_pear, correlation_spear = helper2.impute_one_epoch(encoder1, encoder2, gnn, mlp1, mlp2, graph_dec, decoder1, decoder2, optimizer,
                                                                           total_X_rna_tensor,
                                                                           total_X_rna_tensor_normalized,
                                                                           total_X_atac_tensor,
                                                                           total_X_atac_tensor_normalized,
                                                                           edge_index, emb_size, random_matrix, device, i, niter)
            # correlation_pear = 1
            # correlation_spear = 1
