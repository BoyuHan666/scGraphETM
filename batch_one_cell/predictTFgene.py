...
class CombinedModel(nn.Module):
    ...
    def forward(self, x, edge_index, num, tf_index_list):
...
if __name__ == "__main__":
    ...
    train_tf_label = [0 for _ in range(train_tf_num * gene_num)]
    test_tf_label = [0 for _ in range(test_tf_num * gene_num)]
