...
if __name__ == "__main__":
    ...
    # index_path = '/home/vickarry/projects/ctb-liyue/vickarry/data/data/relation/highly_gene_peak_index_relation.pickle'
    ...
    num_epochs = 500
    ari_freq = 10
    plot_path_rel = "./plot_July24/"
    file_path_rel = './result_ari_July24/'
    title = "TOP5_Peak_NO_HV_" + str(num_of_gene) + '_' + str(num_of_peak)
    ...
    mtx_path = '/home/vickarry/projects/ctb-liyue/vickarry/TF_gene_graph_model/top5_peak_tf_gene.pickle'
