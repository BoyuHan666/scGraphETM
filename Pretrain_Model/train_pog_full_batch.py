...
def train(model_tuple, optimizer1, optimizer2, train_set,
          total_training_set, test_set, metric, ari_freq,
          niter, use_mlp, use_mask, mask1, mask2):
    NELBO = None
    best_ari = 0
    best_train_ari = 0
    best_theta = None
    ...
    (total_X_rna_tensor, total_X_rna_tensor_normalized, total_X_atac_tensor,
     ...
     total_feature_matrix,total_cor_mat, total_edge_index) = total_training_set
...
if __name__ == "__main__":
    ...
    title = "POG_FULL_" + str(num_of_peak)
    emb_size = 600
    emb_size2 = 600
    num_of_topic = 60
    gnn_conv = 'GATv2'
    ...
    (encoder1, encoder2, gnn, mlp1, mlp2, pog_decoder,
     best_ari, best_theta, best_beta_gene, best_beta_peak,
     best_train_ari, best_train_theta,
     train_ari_list, test_ari_list, train_loss_list, test_loss_list) = train(
    ...
    (X_rna_test_tensor, X_rna_test_tensor_normalized, X_atac_test_tensor,
     X_atac_test_tensor_normalized, scRNA_test_anndata, scATAC_test_anndata,
     test_gene_correlation_matrix, test_peak_correlation_matrix,
     test_feature_matrix, text_cor_mat, test_edge_index) = test_set
