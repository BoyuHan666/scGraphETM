...
if __name__ == '__main__':
    ...
    ==============================================================================
    """
    dataset = june13_dataloader.H5AD_Dataset(
            rna_path=rna_path,
            atac_path=atac_path,
    ...
    #     shuffle=shuffle,
    #     collate_fn=june13_dataloader.custom_collate_fn,
    ...
    gnn_model = models.GNN(
        input=graph_feature_size,
        hidden_channels=graph_feature_size * 2,
        output_channels=graph_feature_size,
        num_heads=1,
        device=device,
        dropout=0.2,
    ...
    # rna_copy_normalized = june13_dataloader.normalize(rna_copy)
    # atac_copy_normalized = june13_dataloader.normalize(atac_copy)
    # rna_copy_normalized_tensor = june13_dataloader.to_gpu_tensor(rna_copy_normalized, device)
    # atac_copy_normalized_tensor = june13_dataloader.to_gpu_tensor(atac_copy_normalized, device)
